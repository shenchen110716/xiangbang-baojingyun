...
class OrgServiceTest {
    ...
    void 已验证用户可以提交组织入驻() {
        ...
        assertThat(view.status()).isEqualTo(com.xbb.org.api.OrgStatus.PENDING);
    }
    ...
    void 审核通过后状态变更() {
        ...
        assertThat(orgApi.findById(orgId, ops.userId()).orElseThrow().status()).isEqualTo(com.xbb.org.api.OrgStatus.APPROVED);
    }
