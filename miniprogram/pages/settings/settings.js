const app = getApp();
Page({
  data: { apiBase: '', providers: {}, saving: false, isDevEnv: false },
  onLoad() { this.setData({ apiBase: app.globalData.apiBase, isDevEnv: app.globalData.isDevEnv }); app.request('/providers/status', { silent: true }).then((providers) => this.setData({ providers })).catch(() => {}); },
