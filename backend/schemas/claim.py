...
class ClaimIn(BaseModel): enterprise_id: int; person_id: int; policy_id: Optional[int] = None; description: str; amount: float = Field(default=0,ge=0); medical_cost: float = Field(default=0,ge=0); accident_at: str; accident_place: str; accident_type: str = "工伤事故"; injury_part: str = ""; payee_type: str = ""; hospital: str = ""; diagnosis: str = ""; contact_name: str = ""; contact_phone: str = ""
class ClaimUpdate(BaseModel): description: Optional[str]=None; hospital:Optional[str]=None; diagnosis:Optional[str]=None; injury_part:Optional[str]=None; payee_type:Optional[str]=None; medical_cost:Optional[float]=Field(default=None,ge=0); amount:Optional[float]=Field(default=None,ge=0); contact_name:Optional[str]=None; contact_phone:Optional[str]=None; insurer_report_no:Optional[str]=None; current_handler:Optional[str]=None; deadline:Optional[str]=None; sla_deadline:Optional[str]=None; rejection_reason:Optional[str]=None; review_note:Optional[str]=None; risk_level:Optional[Literal['normal','attention','high']]=None
