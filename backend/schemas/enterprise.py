...
class EnterpriseApplyIn(BaseModel): enterprise_name: str = Field(min_length=1, max_length=160); credit_code: str = Field(default="", max_length=40); contact: str = Field(default="", max_length=80); phone: str = Field(default="", max_length=30); username: str = Field(min_length=3, max_length=80); password: str = Field(min_length=6, max_length=128)
