...
export function updateOperator(id: number, data: { name?: string; phone?: string; password?: string; active?: boolean; enterprise_id?: number; enterprise_role?: EnterpriseRole }) {
