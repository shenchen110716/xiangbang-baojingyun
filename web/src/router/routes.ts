...
export const routes: Array<RouteRecordRaw & { meta: NavMeta }> = [
  ...
  { path: '/enroll-review', name: 'enrollReview', component: () => import('@/views/enroll-review/EnrollReviewView.vue'), meta: { title: '扫码参保审核', group: '业务管理' } },
  ...
  { path: '/report', name: 'report', component: () => import('@/views/reports/ReportsView.vue'), meta: { title: '报表中心', group: '财务' } },
  ...
  { path: '/enroll/:positionId/:mode/:token', name: 'enroll', component: () => import('@/views/enroll/EnrollView.vue'), meta: { title: '扫码参保' } },
]
