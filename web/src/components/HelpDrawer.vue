...
type Role = 'admin' | 'enterprise' | 'salesperson'
...
const ALL: Role[] = ['admin', 'enterprise', 'salesperson']
...
const roleLabel = computed(() => ({
  admin: '平台管理员', enterprise: '投保单位', salesperson: '业务员',
}[currentRole.value]))
...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { h: '数据范围与隔离', p: '平台端可见全平台，单位端仅本租户，项目经理再收敛到被授权用工单位，业务员仅本人；越权读写被拒或强制归属自身。' },
    ],
  },
  {
